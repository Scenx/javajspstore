...
<div class="search-hot overtouch" id="searchHot">
	<dl class="search-keywords" id="hotwords" style="-webkit-transform-origin: 0px 0px 0px; opacity: 1; -webkit-transform: scale(1, 1);">
		<dt>热门搜索</dt>
		<dd class="keywords-list" id="hotwordsBox" style="-webkit-transform-origin: 0px 0px 0px; opacity: 1; -webkit-transform: scale(1, 1);"><a name="wapsssry_none_rsc_rsc1" href="javascript:searchHistoryOrHotword('算法导论');">算法导论</a><a name="wapsssry_none_rsc_rsc2" href="javascript:searchHistoryOrHotword('深入java虚拟机');">深入java虚拟机</a><a name="wapsssry_none_rsc_rsc3" href="javascript:searchHistoryOrHotword('java编程思想');">java编程思想</a><a name="wapsssry_none_rsc_rsc4" href="javascript:searchHistoryOrHotword('计算机科学导论');">计算机科学导论</a><a name="wapsssry_none_rsc_rsc5" href="javascript:searchHistoryOrHotword('我的大脑失控了');">我的大脑失控了</a><a name="wapsssry_none_rsc_rsc6" href="javascript:searchHistoryOrHotword('Oracle从入门到精通');">Oracle从入门到精通</a><a name="wapsssry_none_rsc_rsc7" href="javascript:searchHistoryOrHotword('HTML+CSS3+JavaScript网页设计案例课堂');">HTML+CSS3+JavaScript网页设计案例</a></dd>
	    ...
	    success: function(data) {
	        if(data.status==1){
	        	...
	        	for(var i=0;i<list.length;i++){
	        		$("#productsList").append("<li class='wbox' id='"+list[i].id+"'><a class='link' href='detail?id="+list[i].id+"'></a><a href='detail?id="+list[i].id+"'><div class='img'><img data-src='done' alt='' src='"+list[i].picture+"' id='pi"+list[i].id+"'><span class='bang-t bang-t-35'></span></div></a><div class='wbox-flex'><a href='detail?id="+list[i].id+"'><p class='name'>"+list[i].title+"</p></a><p class='info'></p><div class='price' id='sp"+list[i].id+"'><span class='fl' id='sprice"+list[i].id+"</span></div></div></li>");
	        	}
...
<div class="copyright sn-block tc pdlayout sn-txt-muted">
				Copyright © 2016 -<script type="text/javascript">document.write(new Date().getFullYear())</script> ${config.siteName } 版权所有
			</div>
