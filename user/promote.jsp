...
<body>
    <div class="sn-nav">
		...
		<div class="sn-nav-title of"><a href="../list.jsp">客服qq862351901</a></div>
	...
	<c:if test="${sessionScope.loginUser.status==0 }">
		<div class="input-a sn-block wbox mt30 pr">
			<span><a href="../list.jsp">客服qq862351901</a></span>
		</div>
	</c:if>
	<c:if test="${sessionScope.loginUser.status==1 }">
		...
		<input type="text" value="http://ncwuhz.cn/promote?no=${sessionScope.loginUser.no }">
		</div>
		</div>
	</c:if>
	</section>
