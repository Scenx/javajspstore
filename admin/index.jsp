...
<title>寻师宝典后台管理系统</title>
<meta name="Keywords" content="寻师宝典"/>
<meta name="Description" content="寻师宝典后台管理系统"/> 
<!-- bootstrap - css -->
...
<body>
    ...
    <header class="navbar navbar-default" id="bjui-header">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://www.lxinet.com" target="_blank"><img src="../res/images/xunshibaodian.png" width="135" height="51"></a>
        </div>
                    ...
                    <div id="bjui-collapse0" class="panel-collapse panelContent collapse in">
                        <div class="panel-body" >
                            <ul id="bjui-tree0" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true">
                                ...
                                <li data-id="12" data-pid="1" data-url="productList" data-tabid="productList">老师管理</li>
                                ...
                                <li data-id="15" data-pid="1" data-url="commissionList" data-tabid="commissionList">奖励明细</li>
    ...
    <footer id="bjui-footer">Copyright &copy; 2016 - 2017 <a href="#" target="">寻师宝典</a> 
    </footer>
</body>
</html>