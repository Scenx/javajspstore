...
<div class="index-wrap lazyimg" id="indexWrap">
	...
	<section class="cnn-banner w" id="S_banner">
		...
		<div class="app06 floor-area" id="navCarousel_box" >
				<ul class="fix">
					<li><a name="index_none_floor3_330052" href="#">
					<img alt="" data-src="done" src="images/143262193526726791.jpg"><div class="title">外语</div></a></li>
					<li><a name="index_none_floor3_330051" href="https://weidian.com/?userid=315338226">
					<img alt="" data-src="done" src="images/143262190460206422.jpg">
					<div class="title">学习商城</div>
					</a></li>
					<li><a name="index_none_floor3_330053" href="list.jsp"><img alt="" data-src="done" src="images/143262692801385199.jpg">
					<div class="title">艺术</div></a></li>
					<li><a name="index_none_floor3_330055" href="${config.downloadUrl }">
					<img alt="" data-src="done" src="images/143385208970280372.jpg">
					<div class="title">对外汉语</div></a></li>
<li><a name="index_none_floor3_330054" href="jiaoliu.html">
					<img alt="" data-src="done" src="images/aijia.jpg">
					<div class="title">交流群</div></a></li>
				</ul>
		</div>
		<div class="app01"></div>
