...
<title>凌夕网络Lxinet后台管理系统</title>
<meta name="Keywords" content="凌夕网络Lxinet"/>
<meta name="Description" content="凌夕网络Lxinet后台管理系统"/> 
<!-- bootstrap - css -->
...
<body>
                ...
                <div class="page unitBox">
                    <div class="bjui-pageHeader" style="background:#FFF;">
                        <div style="padding: 0 5px;">
                            ...
                            <h4 style="margin-bottom:20px;">欢迎使用凌夕网络卡密微商城程序&nbsp;<small>最好用的卡密微商城程序</small></h4>
                            	<div class="col-md-6">
                            		<h5>凌夕网络卡密微商城程序</h5>
                                ...
                                <div class="col-md-6">
                                	...
                                	<h5>凌夕网络：<a href="http://www.lxinet.com/" target="_blank">http://www.lxinet.com/</a></h5>
                                    <h5>凌夕网络论坛：<a href="http://bbs.lxinet.com/" target="_blank">http://bbs.lxinet.com/</a></h5>        
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer id="bjui-footer">Copyright &copy; 2012 - 2015 <a href="http://www.lxinet.com" target="_blank">凌夕网络</a> <a href="http://bbs.lxinet.com" target="_blank">凌夕网络论坛</a> <a href="http://www.919dns.com" target="_blank">919数据中心</a>
    </footer>
</body>
</html>