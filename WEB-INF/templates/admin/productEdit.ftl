	                ...
	                <tbody>
	                    ...
	                    <tr>
	                        <td>
	                            ...
	                            <input type="text" name="product.title" id="title"  size="50" placeholder="请输入标题" value="${product.title}">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            <label for="title" class="control-label x90">面额：</label>
	                            <input type="text" name="product.bills" id="bills" data-rule="required;number" size="10" placeholder="请输入面额" value="${product.bills}">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            <label for="title" class="control-label x90">售价：</label>
	                            <input type="text" name="product.money" id="money" data-rule="required" size="10" placeholder="请输入售价" value="${product.money}">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
