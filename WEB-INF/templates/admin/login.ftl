...
body {
    background: url(res/images/xunshibaodian.png) no-repeat center center fixed;
...
<div class="main_box">
	...
	<div class="login_box">
        <div class="login_logo">
            <img src="res/images/xunshibaodian.png" >
        </div>
	...
	<div class="bottom">Copyright &copy; 2016 - 2017 <a href="#" >寻师宝典</a>
</div>
</body>
</html>