	                ...
	                <tbody>
	                    ...
	                    <tr>
	                        <td>
	                            ...
	                            <input type="text" name="product.bills" id="bills" data-rule="required;number" size="10" placeholder="请输入面额">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            <label for="title" class="control-label x90">售价：</label>
	                            <input type="text" name="product.money" id="money" data-rule="required;number" size="10" placeholder="请输入售价">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
